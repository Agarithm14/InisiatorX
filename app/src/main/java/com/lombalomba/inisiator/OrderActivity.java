...
public class OrderActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(0xFFD83D12);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            WebView mWebView = v.findViewById(R.id.webOrder);
            // mWebView.loadUrl("https://www.google.com/search?q="+getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1){
                mWebView.loadUrl("https://www.inisiator.com/ini-print/order-active.php");
            }
            else {
                mWebView.loadUrl("https://www.inisiator.com/ini-print/order-history.php");
            }
